...
const NuevoConcurso = () => {
  ...
  /* Buscar un termino en campos autocomplete/search */
  const handleSearch = async (tipo, dato) => {
    const draft = { tipo: tipo, dato: dato };

    try {
      const response = await axios.post(
        "http://localhost/concursos/API/search_data.php",
        draft,
        {
          headers: {
            "Content-Type": "application/json",
    ...
    <>
      <Container>
        <Typography variant="h4" className="mt-2 mb-4" align="center">
          Ingresar un Nuevo Concurso
        </Typography>

        <Card className="shadow-lg" sx={{ maxWidth: 1400 }}>
          <CardContent>
            <form
              id="formulario"
            ...
            >
              <Stack gap={3}>
                        ...
                        render={({ field: { ref, onChange, ...field } }) => (
                          <Autocomplete
                            ...
                            onInputChange={(event, newInputValue) => {
                              handleSearch(event.target.name, newInputValue);
                            }}
                            renderInput={(params) => (
                              <TextField
                                {...params}
                ...
                {/* Asignatura */}
                <div>
                  <div id="asignaturaForm" style={{ overflowX: "hidden" }}>
                    <div
                      style={{
                        boxShadow:
                          "0 10px 8px var(--purple-transparent), 0 -10px 8px var(--purple-transparent)",
                        borderBottom: "1px solid" + deepPurple[400],
                        borderTop: "1px solid" + deepPurple[400],
                        paddingBlock: 25,
                        marginBlock: 15,
                      }}
                    >
                          ...
                          <FormControlLabel
                            control={
                              <Checkbox
                                ...
                                onChange={() => setConExtension(!conExtension)}
                  ...
                  {asignaturasAgregadas && asignaturasAgregadas.length > 0 && (
                    <div
                      style={{
                        marginTop: 15,
                        padding: "10px 0",
                        ...
                        {asignaturasAgregadas.map((el, i) =>
                          el.conExtension ? (
                            <Chip
                              ...
                              onDelete={() => handleDeleteAsignatura(el)}
                            />
                          ) : (
                            <Chip
                              key={i}
                ...
                <div className="row ">
                  ...
                  <div className="col-sm-12 col-md-6 col-lg-6 col-xl-4 d-flex flex-column gap-3">
                    ...
                    {mostrarInvestigacion && mostrarInvestigacion !== "1" && (
                      <Controller
                        ...
                        rules={{ required: true }}
                        render={({ field }) => (
                          <RadioGroup {...field} style={{ marginLeft: 10 }}>
                ...
                {/* Postulantes */}
                <div>
                  <div id="postulantesForm" style={{ overflowX: "hidden" }}>
                    <div
                      style={{
                        boxShadow:
                          "0 10px 8px var(--purple-transparent), 0 -10px 8px var(--purple-transparent)",
                  ...
                  {postulantesAgregados && postulantesAgregados.length > 0 && (
                    <div
                      style={{
                        marginTop: 15,
                        borderRadius: 4,
                ...
                {/* Comision Asesora */}
                <div>
                  <div id="comisionAsesoraForm" style={{ overflowX: "hidden" }}>
                    <div
                      style={{
                        boxShadow:
                          "0 10px 8px var(--purple-transparent), 0 -10px 8px var(--purple-transparent)",
                ...
                {/* Cantidad de cargos - Recusaciones */}
                <div className="row ">
                  {/* Cantidad de cargos */}
                  <div className="col-sm-12 col-md-6 col-lg-6 col-xl-4 d-flex flex-column gap-3">
                    <SimpleInput
                ...
                {/* Seleccionados */}
                <div>
                  <div id="asignaturaForm" style={{ overflowX: "hidden" }} s>
                    <div
                      style={{
                        boxShadow:
                          "0 10px 8px var(--purple-transparent), 0 -10px 8px var(--purple-transparent)",
                  ...
                  {seleccionadosAgregados &&
                    seleccionadosAgregados.length > 0 && (
                      <div className="row">
                        {Object.entries(juradosD).map(([key, value], i) => (
                          <div className="col-md" key={i}>
                            <div
                              style={{
                                ...
                                overflowX: "auto",
                                display:
                                  value[0].jurado === null ? "flex" : "block",
                              }}
                            >
                ...
                {/* Fecha de Pase a Archivo - Fecha de Designación*/}
                <div className="row ">
                ...
                <div>
                  ...
                  {designadosAgregados && designadosAgregados.length > 0 && (
                    <ScrollContainer
                      style={{
                        marginTop: 15,
                        padding: "10px 0",
